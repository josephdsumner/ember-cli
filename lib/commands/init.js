...
module.exports = Command.extend({
  ...
  async run(commandOptions, rawArgs) {
    ...
    let languageInfo = getLangArgResult(commandOptions.language);
    let languageDefault = "";
    if(!languageInfo.result && (languageInfo.langArgValue !== languageDefault))  {
      let message = languageInfo.message;
      return Promise.reject(new SilentError(message));
    }
