...
function getCliMsg(langArg) {
  let message = `Detected a language specification starting with \`-\` -- is ${langArg} meant to be an option in your ember-cli command? This issue is likely caused by using the \`--language\` flag without a specification. If used, the language option must specfify a valid language code. For default language behavior, remove the flag.`;
  return message;
}
