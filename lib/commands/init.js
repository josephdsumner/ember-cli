...
module.exports = Command.extend({
  ...
  async run(commandOptions, rawArgs) {
    ...
    if (commandOptions.lang) {
      let langArgInfo = getLangArg(commandOptions.lang);
      if (langArgInfo.message.body) {
        let message = langArgInfo.message;
        langArgInfo.writeMsg(message, this.ui);
      }
      commandOptions.lang = getLangArg(commandOptions.lang).result;
    }
